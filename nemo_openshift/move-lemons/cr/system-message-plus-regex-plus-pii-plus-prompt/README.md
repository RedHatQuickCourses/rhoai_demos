...
```bash
export LLM_API_BASE="https://maas-rhdp.apps.maas.redhatworkshops.io/v1"
export LLM_MODEL_NAME="microsoft-phi-4"
export LLM_API_KEY="your-api-key"

export INJECTION_GUARD_API_BASE="https://maas-rhdp.apps.maas.redhatworkshops.io/v1"
...
```bash
curl -X POST "https://$NEMO_ROUTE/v1/guardrail/checks" \
  -H "Content-Type: application/json" \
  -d '{
    "model": "'"$LLM_MODEL_NAME"'",
